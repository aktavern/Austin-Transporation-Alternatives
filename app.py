...
# FUNCTION TO RETURN OTHER HUMAN READABLE CONTENT, 
# AND THE COUNT IF IT EXISTS 
def variables(query_results):
    ...
    # verify if the provided date is in the database
    ...
    # if the date is not in the database, return that there
    # is no data on the count. otherwise, return the count for
    # that day. 
    if future_count == []:
        count = "None"
    else:
